...
# If n is not prime, there must be atleast one divisor less than the root of n.
...
while i ** 2 < n:
    while n % i == 0:  # If n divided by i leaves no remainder, i is a factor.
        n /= i  # The largest prime factor unknown. Once the while loop fails,
        # the value of n is changed to n divided by its largest factor
        # resulting in the largest prime factor.
